  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="PacketForge designs, deploys, and manages secure, high-performance network and VPN infrastructures for modern businesses."
        />
        <meta property="og:title" content="PacketForge — Secure Networking Solutions" />
        <meta
          property="og:description"
          content="Bespoke network architecture and VPN solutions built for performance, resilience, and total data security."
        />
      ...
      <header style={{ borderBottom: '1px solid #111' }}>
        ...
        >
          ...
          <nav style={{ display: 'flex', gap: 18 }} aria-label="Main navigation">
            <Link href="#services">
              <a className="muted">Services</a>
            </Link>
            <Link href="#about">
              <a className="muted">About</a>
            </Link>
            <Link href="#contact">
              <a className="muted">Contact</a>
            </Link>
          </nav>
        </div>
      </header>
      ...
      <main>
        <section style={{ padding: '60px 0', textAlign: 'center' }}>
          <div className="container">
            ...
            <p
              className="muted"
              style={{ maxWidth: 760, margin: '18px auto' }}
            >
              Bespoke network architecture and VPN solutions built for performance,
              resilience, and total data security.
            </p>
        ...
        <section id="services" style={{ padding: '40px 0', background: '#050505' }}>
          <div className="container">
            <h2 style={{ color: 'var(--gold)' }}>
              Precision Networking for Modern Business
            </h2>
            <p className="muted">
                ...
                {status.message && (
                  <p
                    style={{
                      marginTop: 10,
                      fontSize: 14,
                      color: status.type === 'success' ? 'var(--gold)' : '#ff6b6b',
                    }}
                  >
                    {status.message}
                  </p>
      ...
      <footer
        style={{ borderTop: '1px solid #111', padding: '24px 0', textAlign: 'center' }}
        className="muted"
      >
        <div className="container">
